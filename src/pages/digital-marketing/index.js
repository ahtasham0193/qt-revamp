        ...
        <Layout>
                ...
                <div className="w-full p-6">
                    <div className="w-full">
                        ...
                        <div className="thin-container w-full">
                            ...
                            <h2 className="text-xl sm:text-[22px] text-center sm:text-start font-normal mt-5">
            ...
            <section>
                <div className="w-full mt-24">
                    <div className="container">
                        <div className="w-full">
                            <h2 className="text-xl sm:text-3xl font-semibold text-center">Services what we offer</h2>
                        </div>
                        <div className="w-full mt-10">
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                <div className="bg-light-primary-color rounded-lg p-8">
                                    <h2 className=" text-[22px] font-normal text-gray-700 mb-4">Search Engine Optimization</h2>
                                    <p className="text-gray-400 text-base ">Increase the traffic and visibility of your business</p>
                                </div>
                                <div className="bg-light-primary-color rounded-lg p-8">
                                    <h2 className=" text-[22px] font-normal text-gray-700 mb-4">Pay-Per-Click Services</h2>
                                    <p className="text-gray-400 text-base ">Sales and lead generation that assures relevant paid traffic</p>
                                </div>
                                <div className="bg-light-primary-color rounded-lg p-8">
                                    <h2 className=" text-[22px] font-normal text-gray-700 mb-4">Social Media Marketing</h2>
                                    <p className="text-gray-400 text-base ">Present brand on all social media platforms</p>
                                </div>
                                <div className="bg-light-primary-color rounded-lg p-8">
                                    <h2 className=" text-[22px] font-normal text-gray-700 mb-4">Search Engine Marketing</h2>
                                    <p className="text-gray-400 text-base ">Ranking and visibility by putting your brand to targeted customers</p>
                                </div>
                                <div className="bg-light-primary-color rounded-lg p-8">
                                    <h2 className=" text-[22px] font-normal text-gray-700 mb-4">Email Marketing</h2>
                                    <p className="text-gray-400 text-base ">E-mail marketing strategies for different businesses</p>
                                </div>
                                <div className="bg-light-primary-color rounded-lg p-8">
                                    <h2 className=" text-[22px] font-normal text-gray-700 mb-4">SMS/Call Marketing</h2>
                                    <p className="text-gray-400 text-base ">More reliable SMS / Calls Marketing campaigns</p>
                                </div>
                                <div className="bg-light-primary-color rounded-lg p-8">
                                    <h2 className=" text-[22px] font-normal text-gray-700 mb-4">Content Marketing</h2>
                                    <p className="text-gray-400 text-base ">Creative storytelling that generate tangible results</p>
                                </div>
                                <div className="bg-light-primary-color rounded-lg p-8">
                                    <h2 className=" text-[22px] font-normal text-gray-700 mb-4">Affiliate/Influencer Marketing</h2>
                                    <p className="text-gray-400 text-base ">Top notch affiliate marketing, acquire more leads and sales.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="mt-24">
                <div className="w-full mt-24">
                    <div className="container">
                        <div className="w-full">
                            <h2 className="text-xl sm:text-3xl font-semibold text-center">Our clients</h2>
                        </div>
                        <div className="mt-10 max-w-[600px] mx-auto">
                            <Accordion title="DUPAS">
                                <Image
