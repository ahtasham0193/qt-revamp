                ...
                <div className="w-full p-6">
                    <div className="w-full">
                        <div className="thin-container w-full">
                            ...
                            Our elite in-house team specializes in software engineering, product development, cloud architecture, and digital transformation. Our diverse team is united to create some extraordinary apps for your business, and rapidly, reliably delivers software that meets the needs of the world’s most demanding organizations. 
                            Features do matter in the performance of the mobile apps, which is why we look at multiple featured apps in app stores. In such a crowded marketplace, only the perfect featured app stands out. This not only outlines the uniqueness of your business but can generate thousands of leads
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="container">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-10">
                            <div className="md:col-span-1 px-5 sm:px-[74px] py-4">
                                ...
                                <p className="text-sm sm:text-lg mt-5">The key advantage of native applications is performance. Building native apps means Objective-C on iOS, and Java on Android. These apps give you quality and great performance. We build native apps in iOS, Android, and Windows platforms. Native apps are the preference for companies that are looking to get the essence on a solitary stage.</p>
                            </div>
                            <div className="md:col-span-1 px-5 sm:px-[74px] py-4">
                                <Image
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-10">
                            ...
                            <div className="md:col-span-1 px-5 sm:px-[74px] py-4">
                                ...
                                <p className="text-sm sm:text-lg mt-5">Transform your business experience through one app across all the mobile platforms. Eliminate costly separate projects and get instant experience of your code on all hardware with the help of QuaidTech's skilled developers through your favourite UI frameworks.</p>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-10">
                            <div className="md:col-span-1 px-5 sm:px-[74px] py-4">
                                ...
                                <p className="text-sm sm:text-lg mt-5">We produce tailor made responsive design and development for massive conversions. At QuaidTech, we follow Responsive Web Design, which is a plan that suggests the outline and execution of a website according to client conduct and environment on the screen size and working arrangement of their gadget.</p>
                            </div>
