                ...
                <div className="w-full p-6">
                    <div className="w-full">
                        <div className="thin-container w-full">
                            ...
                            <h2 className="section-heading text-[22px] font-normal text-center mt-4">Get Tailor-Made Software For Your Company</h2>
                            <p className="mt-6">
                            Looking for timely project completion with fewer error rates and better software development expertise? Get customized software and manifest all that and much more in a blink of an eye! Gone are the days when you and your brand relied on the manual workforce. This is the digital transformation era, and you must jump on the bandwagon if you haven't already. With our impeccable software development services, the journey is going to be an unforgettable one.
                            </p>
                            ...
                            <h1 className="section-heading text-4xl font-bold text-center mt-8">
                                Why shouldn’t you look beyond us?
                            </h1>
                            <p className="mt-6">
                            ...
                            <ul className=" list-disc mt-5 pl-4">
                                ...
                                <li>
                                We aim to know your and your brand's needs and personalize the software accordingly.
                                </li>
                                <li>
                                Provide quality assurance of software as well as testing.
                                </li>
                                <li>
                                Call us problem solvers; whether you are a start-up or decades-old healthcare, we are up for the challenge.
                                </li>
                                <li>
                                Have a 360-degree approach to provide you with a flawless experience.
                                </li>
                                <li>
                            ...
                            <p className="mt-4">Software development is not an ordinary system. It is complex and comprises a series of steps requiring expertise. Here is how it is defined:</p>
                            <div className="mt-10 max-w-[600px] mx-auto">
                                <Accordion title="Step No 1: Identification Of Needs">
                                This is a specific research-based step and holds primary importance. It revolves wholly around the identification of a brand’s needs, and involves extensive marketing research and brainstorming. Our team of experts first conducts in-depth market research, and then looks into the brand's needs. In addition to this, we also discuss the brand's aspects, including strengths, weaknesses, and opportunities. 
                                Pro Tip: The best way to do this is to get feedback from potential and old customers
                                </Accordion>
                                <Accordion title="Step No 2: Analysis Of Requirements">The second step in software development is the in-depth analysis of the requirements. This is crucial in the development of software as it decides the fate of the software. The developers at this stage determine the software development approach, such as a waterfall or V model. Moreover, the developers decide on the detailed outline of every component, scope, testing parameters, and task details of the developers to ensure the delivery of a quality product.</Accordion>
                                ...
                                <Accordion title="Step No 4: Developing And Implementation">After the design is complete comes developing and implementing the parameters of the design. The product specifications and requirements decided in the third step are coded at this stage. Besides, the front-end developers design interfaces and back-ends, and at the same time, the administrators add relevant data to the database. After finishing with the coding, the developers then implement the product into the environment as part of the testing. This helps us determine whether the performance is as per the requirements.</Accordion>
                                <Accordion title="Step No 5: Testing">At this phase, it's time to test the software for bugs. Additionally, the verification is done before it can be delivered to the users. Our expert testers verify the product's functions and ensure its performance is according to the requirements. If there is any defect in the code, the testers notify the developers. They work on the software, improve and repeat the process until it is ready.</Accordion>
                            ...
                            The whole cycle consists of methodologies used to develop the software is known as Software Development Life Cycle (SDLC), an international standard used by software houses globally to develop and optimize the software per the brand's needs. We use the waterfall model for SDLC. Here are the seven main steps included in it that lead to a particular, tailor-made software:
                            </p>
                            <ul className="list-disc mt-5 pl-4">
                                <li>
